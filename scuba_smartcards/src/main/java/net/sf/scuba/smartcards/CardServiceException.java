  ...
  private static String statusWordToString(short sw) {
    switch (sw) {
      case ISO7816.SW_END_OF_FILE:
        return "END OF FILE";
      case ISO7816.SW_LESS_DATA_RESPONDED_THAN_REQUESTED:
      ...
      case ISO7816.SW_UNKNOWN:
        return "UNKNOWN";
      case ISO7816.SW_CARD_TERMINATED:
